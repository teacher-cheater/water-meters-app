...
function App() {
  ...
  const totalItems = 200; // Placeholder for the total number of items (should be retrieved from API)

  useEffect(() => {
    fetch(
      `http://showroom.eis24.me/api/v4/test/meters/?limit=${itemsPerPage}&offset=${
